<?php
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  $script_name = "$Id: menu.inc.php,v 1.1 2003/10/06 19:12:21 chaot Exp $";
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    #if ( $debugging["html_enable"] ) $debugging["ausgabe"] .= "level0sql: ".$sql.$debugging["char"];
        ...
        if ( $cfg["menu"]["level1"]["enable"] == -1 ) {
            ...
            if ( $right == -1 ) {
                ...
                if ( strpos($environment["ebene"],$level1array["entry"]) == 1 || ( $environment["kategorie"] == $level1array["entry"] && $environment["ebene"] == "" ) ) {
                    // ???open.png
                    $ausgaben["ordner"] = "<a class=\"".$cfg["menu"]["level1"]["style"]."\" href=\"".$pathvars["virtual"]."/".$level1array["entry"].".html\"><img src=\"../../images/".$environment["design"]."/".$cfg["menu"]["image"]."open.png\" width=\"16\" height=\"16\" align=\"bottom\" border=\"0\" alt=\"".$level1array["label"]."\"></a>";
                    // mandatory
            ...
            if ( $cfg["menu"]["level2"]["enable"] == -1 ) {
                ...
                if ( $right == -1 ) {
                    if ( $level2array["entry"] != "" ) {
                       ...
                       $ausgaben["punkte"] .= "<a class=\"".$cfg["menu"]["level2"]["style"]."\" href=\"".$pathvars["virtual"]."/".$level1array["entry"]."/".$level2array["entry"].".html\">".$level2array["label"]."</a><br>";
                    } else {
