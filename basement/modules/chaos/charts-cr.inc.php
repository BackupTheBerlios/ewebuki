<?php
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// "$Id: charts-cr.inc.php,v 1.1 2003/10/06 19:12:25 chaot Exp $";
// "short description";
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if ( $environment["parameter"][1] == "check" ) {
        ...
        for ( $i = 1; $i <= 4; $i++ ) {
            ...
            while (!feof($fp)) {
                $line = fgets($fp, 131072);
                if ( strstr($line,"<!-- pageArea : [ PAGE-CONTROLS ]") ) {
                    $read = false;
                    #$ausgaben["output"] .= "end found\n";
                }

                if ( $read == true && trim($line) != "" ) {
                    ...
                    while ( strstr($line, "<b>") ) {
                        ...
                        $j++;
                        #$row[$j] = ucwords(strtolower($wert));
                        $row[$j] = strtolower($wert);
                        if ( $j == 3 ) {
                            $j = 0;
                            #if ( in_array($row[1], $newentry) ) {
                            #    $marke = " <b>(new)</b>";
                            #} else {
                            #    $marke = "";
                            #}
                ...
                if ( strstr($line,"<!-- pageArea : [ CHARTS-TABLE ]") ) {
                    $read = true;
